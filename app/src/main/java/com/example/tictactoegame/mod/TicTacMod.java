...
public class TicTacMod {
    ...
    private boolean doWinOrBlockMove(int element) {
        ...
        //Горизонтальный lst line (Первая)
        ...
        // Горизонтальная линия 2nd line (Втаря)
        ...
        // горизонтальная линия 3rd line (Третья)
        ...
        // Вертикальня линия 1st line (Первая)
        ...
        // Вертикальная линия 2nd line (Вторая)
        ...
        // Вертикальная линия 3rd line (Третья)
